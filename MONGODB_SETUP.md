...
mongosh < setup-yega-db.js

# Or connect and run manually
mongosh
use yega
# Then copy-paste the contents of setup-yega-db.js
```
...
- [ ] App can connect: `node test-mongodb.js`

## 🎉 Next Steps

After MongoDB is installed and configured:
1. Run the YEGA application: `./deploy.sh --caddy`
